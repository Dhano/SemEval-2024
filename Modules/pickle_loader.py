...
def load_efr():
    with open("../Pickles2/idx2utt.pickle","rb") as f:
        idx2utt = pickle.load(f)
    with open("../Pickles2/utt2idx.pickle","rb") as f:
        utt2idx = pickle.load(f)
        
    with open("../Pickles2/idx2emo.pickle","rb") as f:
        idx2emo = pickle.load(f)
    with open("../Pickles2/emo2idx.pickle","rb") as f:
        emo2idx = pickle.load(f)
        
    with open("../Pickles2/idx2speaker.pickle","rb") as f:
        idx2speaker = pickle.load(f)
    with open("../Pickles2/speaker2idx.pickle","rb") as f:
        speaker2idx = pickle.load(f)

    with open("../Pickles2/weight_matrix.pickle","rb") as f:
        weight_matrix = pickle.load(f)

    with open("../Pickles2/train_data_trig.pickle","rb") as f:
        my_dataset_train = pickle.load(f)

    with open("../Pickles2/test_data_trig.pickle","rb") as f:
        my_dataset_test = pickle.load(f)
        
    with open("../Pickles2/global_speaker_info_trig.pickle","rb") as f:
        global_speaker_info = pickle.load(f)
        
    with open("../Pickles2/speaker_dialogues_trig.pickle","rb") as f:
        speaker_dialogues = pickle.load(f)
        
    with open("../Pickles2/speaker_emotions_trig.pickle","rb") as f:
        speaker_emotions = pickle.load(f)
        
    with open("../Pickles2/speaker_indices_trig.pickle","rb") as f:
        speaker_indices = pickle.load(f)
        
    with open("../Pickles2/utt_len_trig.pickle","rb") as f:
        utt_len = pickle.load(f)
        
    with open("../Pickles2/global_speaker_info_test_trig.pickle","rb") as f:
        global_speaker_info_test = pickle.load(f)
        
    with open("../Pickles2/speaker_dialogues_test_trig.pickle","rb") as f:
        speaker_dialogues_test = pickle.load(f)
        
    with open("../Pickles2/speaker_emotions_test_trig.pickle","rb") as f:
        speaker_emotions_test = pickle.load(f)
        
    with open("../Pickles2/speaker_indices_test_trig.pickle","rb") as f:
        speaker_indices_test = pickle.load(f)
        
    with open("../Pickles2/utt_len_test_trig.pickle","rb") as f:
