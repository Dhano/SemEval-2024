...
class ERC_MMN(nn.Module):
    def __init__(self,hidden_size,weight_matrix,utt2idx,batch_size,seq_len):
        ...
        self.rnn_c = myRNN(hidden_size*3,hidden_size*2,4)
        
        #self.rnn_e = myRNN(hidden_size*2,hidden_size*2,4)
        self.rnn_e = myTransformerEncoder(hidden_size*2,hidden_size*2,4)
...
class EFR_TX(nn.Module):
    def __init__(self, weight_matrix, utt2idx, nclass, ninp, nhead, nhid, nlayers, device, dropout=0.5):
        ...
        self.transformer_encoder =myTransformerEncoder(ninp,nhid,4)
