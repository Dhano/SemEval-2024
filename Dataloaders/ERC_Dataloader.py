...
our_training_path = "../Data/train.csv"
our_testing_path = "../Data/val.csv"
save_path = "../Pickles/"
...
emos = ['disgust', 'joy', 'surprise', 'anger', 'fear', 'neutral', 'sadness','contempt']
idx2emo = {}
emo2idx = {}
ctr = 0
...
for utt in idx2utt.values():
    ...
    if pp_utt != "pad":
      weight_matrix[utt2idx[pp_utt]] = sent2emb[pp_utt]
